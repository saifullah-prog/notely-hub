      ...
      <header className="flex items-center gap-3 px-4 h-16 shrink-0 border-b border-border bg-sidebar">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          {user && (
            <Link
              to="/premium"
              className="flex items-center gap-2 px-3 py-2 rounded-full bg-foreground text-background text-sm font-bold hover:scale-105 transition"
            >
              <Crown className="size-4" /> <span className="hidden lg:block">Premium</span>
            </Link>
          )}
          {isAdmin && (
            <Link
